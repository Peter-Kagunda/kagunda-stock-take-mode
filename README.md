...
[![WordPress Plugin](https://img.shields.io/badge/WordPress-Plugin-blue.svg)](https://wordpress.org/plugins/kagunda-stock-take-mode-for-woocommerce/)
[![Live Demo](https://img.shields.io/badge/Demo-Live%20Preview-success.svg)](https://wordpress.org/plugins/kagunda-stock-take-mode-for-woocommerce/?preview=1)
...
* **[View on WordPress.org](https://wordpress.org/plugins/kagunda-stock-take-mode-for-woocommerce/)**
* **[Check out the Live Demo](https://wordpress.org/plugins/kagunda-stock-take-mode-for-woocommerce/?preview=1)**

---

## Description

**Stock Take Mode for WooCommerce** lets store owners temporarily pause purchasing across the whole store, or on specific products, while they run an inventory count, perform maintenance, or execute a seasonal stock-take.

Customers see a clear banner explaining what is happening, can leave their email to be notified when you re-open, while your staff can keep working as normal.

### Features

* **One-click start and stop:** A status card at the top of the settings screen shows whether Stock Take Mode is active, scheduled, or off, with "Start now" and "Stop now" buttons. You can also turn it off directly from the admin toolbar.
...
* Improved: Start and end notifications now fire at the scheduled time even when nobody is browsing.

---

## Support & Custom Development

**Contact me for custom plugin design or web development!** If you need custom features added to this plugin or bespoke WordPress/WooCommerce development for your store, feel free to reach out.
